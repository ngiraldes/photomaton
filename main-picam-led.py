...
class MainApp(App):
    ...
    def light_on(*largs):
        Clock.schedule_once(partial(led_flash, 34))

    def light_off(*largs):
        Clock.schedule_once(partial(led_off, 34))

    def light_5(*largs):
        Clock.schedule_once(partial(led_on, 34, [0, 0, 255]))    
    
    def light_4(*largs):
        Clock.schedule_once(partial(led_on, 34, [255, 255, 0]))    

    def light_3(*largs):
        Clock.schedule_once(partial(led_on, 34, [255, 145, 0]))    

    def light_2(*largs):
        Clock.schedule_once(partial(led_on, 34, [255, 95, 0]))    

    def light_1(*largs):
        Clock.schedule_once(partial(led_on, 34, [255, 0, 0]))    
